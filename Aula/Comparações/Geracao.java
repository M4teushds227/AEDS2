...
abstract class Geracao {
	protected int contMov = 0;
	protected int contCom = 0;
	protected int[] array;
	protected int n;
	...
	public void conts(){
		System.out.println("Quantidades de Movimentações : " + getContMov());
		System.out.println("Quantidades de Comparações : " + getContCom());
	}
	abstract public void contsT();
}
